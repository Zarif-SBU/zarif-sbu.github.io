  ...
  return (
    <div className="flex flex-col bg-background text-foreground min-h-screen animate-fadeIn">
      <section className="flex w-full mt-10">
        <div className="flex-col w-2/5 py-10 px-6 md:px-16 flex mb-20">
          <Gavel size={200} className="mb-20" />
          <h1 className="text-5xl font-bold mb-2">PoliTech </h1>
          <p className="text-lg max-w-2xl opacity-90">
            Political <strong>research team</strong> under the mentorship of Dr. Robert F. Kelly at Stony Brook University
          </p>
          <div className="flex gap-4 mt-10">
            <a href="https://www.stonybrook.edu/commcms/vertically-integrated-projects/teams/_team_page/team_page.php?team=PoliTech" target="_blank" rel="noopener noreferrer" className="px-6 py-3 rounded-xl bg-primary text-primary-foreground shadow-lg hover:opacity-90 transition">
              Read More
            </a>
          </div>
        </div>
        <div className="flex-1 p-6 overflow-y-auto mt-30 ">
          <div className="border-l-4 border-border pl-6">
            <h1 className="text-5xl mb-4 font-semibold">Our Mission</h1>
            <p className="text-lg leading-relaxed mb-6">
              Promote fair representation of the American people in U.S. elections 
      ...
      <section className="w-full px-6 md:px-16 text-center">
        ...
        <div className="grid md:grid-cols-2 gap-10 max-w-4xl mx-auto">
          {[
            "Designed and implemented interactive analysis tools to evaluate district plans",
            "Redesigned the main GUI to improve usability, layout clarity, and visual hierarchy",
            "Wrote scripts to process geospatial data in Python",
            "Mentored new team members and wrote internal documentation",
          ].map((item, i) => (
      ...
      <section className="w-full px-6 md:px-16 text-center my-20">
          {/* UI Comparison */}
          <div id="ui-comparison" className=" mb-20">
            <h2 className="text-4xl font-bold text-center text-foreground">Old GUI vs New GUI</h2>
            <p className="text-sm lg:text-base leading-relaxed text-foreground mb-4 text-center">
          ...
          <h2 className="text-4xl text-foreground font-bold mt-12 text-center">Visualization tools</h2>
          <p className="text-sm lg:text-base leading-relaxed text-foreground mb-4 text-center">
          ...
          <Carousel_Wrapper 
            ...
            descriptions={[
              "Plan selection dialog which prompts users to choose from available district plans before moving to the main analysis interface",
              "Summary table comparing selected plan metrics to the enacted plan",
              "Box and whisker plot visualizing randomly generated plans from our districting algorithm. The algorithm is made with the help MGGG software package. We compare selected plan against the distribution of random plans to evalute if the selected district has overpacking or under-representation of selected demographics.",
              "The red and blue dots come in pairs and represent Democratic and Republican vote shares. Each pair is a data point representing a precinct in the selected district state. The scatter plot helps visualize if there are demographic bias towards certain canditates",
